...
public class DoctorService {
    ...
    /* by doctor/admin */
    public ResponseEntity<Appointment> createNewAppointment(Appointment appointment, int doctorId) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(appointment);
